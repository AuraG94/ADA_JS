//Nuestra tarea es contar la cantidad de números impares que 
//hay desde el número 0 hasta un número X (inclusive). 
...
//8.Ejemplo de Ejecución: Si el usuario ingresa 10, 
//el programa debe imprimir: “La cantidad de números impares desde 0 hasta 10 (inclusive) es: 5”
...
console.log (`la cantidad de numeros impares entre 0 y ${numero} es: ${impares}`);
